...
snowballEdge get-certificate --certificate-arn "arn from list-certificates command" > snow_cert.pem
...
sudo chmod 0644 /etc/pki/ca-trust/source/anchors/snow_cert.pem
